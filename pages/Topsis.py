...
def run():
    ...
    st.markdown(
        ...
        Bobot: 25%
        - dianggap sebagai manfaat karena mempertimbangkan kualitas dan ketersediaan sumber daya manusia yang berkualitas akan memberikan kontribusi positif terhadap produktivitas perusahaan.
        ...
        Jenis: Benefit (Manfaat)
        Bobot: 30%
        - dianggap sebagai manfaat karena teknologi yang lebih canggih dapat meningkatkan efisiensi dan kualitas produksi.
        ...
        Jenis: Cost (Biaya)
        Bobot: 20%
        - dianggap sebagai biaya karena mencakup investasi awal yang perlu dikeluarkan oleh perusahaan. Semakin rendah biaya investasi awal, semakin baik.

        ---

        - Dampak Lingkungan 
        (1 = tinggi, 2 = sedang, 3 = rendah, 4 = sangat rendah)
        Jenis: Cost (Biaya)
        - dianggap sebagai biaya karena perusahaan mungkin perlu mengeluarkan biaya tambahan untuk memitigasi dampak negatifnya. Semakin rendah dampak lingkungan, semakin baik.
